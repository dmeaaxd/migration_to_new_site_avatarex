...
def db_hard_qual():
    ...
    for setting in settings_records:
        ...
        json_data = {
            ...
            "databaseSettings": {
                "databaseLink": setting.database_link,
                "rephrasePrompt": setting.database_message_format,
                "maxResultsCount": setting.database_repeat,
    ...
    file_path = os.path.join(output_dir, 'db_hard_qual.json')
    ...
    print(f"Обработано {counter} настроек DB Hard Qual")
